...
class Ticket {
    ...
    updateStatus(newStatus){
        ...
        console.log(`The order for customer ${customerId} is now ${queued}.`)
    }
}
...
//CODE HERE
let firstTicket = new Ticket('food ordered: pizza, bread, and soda', 'ordered at: 7:03 PM', 'customer: 575', 'queued')
